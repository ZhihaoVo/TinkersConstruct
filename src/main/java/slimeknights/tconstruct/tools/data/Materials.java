...
final class Materials {
  ...
  public static final IMaterial bone  = mat(MaterialIds.bone, true, "ede6bf", TinkerModifiers.fractured);
  // tier 2
  public static final IMaterial iron        = mat(MaterialIds.iron, TinkerFluids.moltenIron, false, "cacaca", TinkerModifiers.reinforced);
  ...
  public static final IMaterial roseGold      = mat(MaterialIds.roseGold, TinkerFluids.moltenRoseGold, false, "ffdbcc", TinkerModifiers.enhanced);
  ...
  // tier 3 (nether)
  public static final IMaterial cobalt = mat(MaterialIds.cobalt, TinkerFluids.moltenCobalt, false, "2882d4", TinkerModifiers.lightweight);
  // tier 4
  ...
  public static final IMaterial queensSlime = mat(MaterialIds.queensSlime, TinkerFluids.moltenQueensSlime, false, "236c45", TinkerModifiers.overlord);
  ...
  public static final IMaterial lead = mat(MaterialIds.lead, false, "4d4968", TinkerModifiers.heavy);
  public static final IMaterial silver = mat(MaterialIds.silver, false, "d1ecf6", TinkerModifiers.smite);
  ...
  public static final IMaterial steel = mat(MaterialIds.steel, false, "a7a7a7", TinkerModifiers.sturdy);
...
//  public static final IMaterial slimevine_purple = mat(MaterialIds.slimevine_purple, true, "c873c8");
  ...
  private static IMaterial mat(MaterialId location, Supplier<? extends Fluid> fluid, boolean craftable, String materialColor, @Nullable DataModifierEntry trait) {
    IMaterial material = new DataMaterial(location, fluid, craftable, materialColor, trait);
    allMaterials.add(material);
    return material;
  }

  /** Creates a material with a fluid and a single trait */
  private static IMaterial mat(MaterialId location, Supplier<? extends Fluid> fluid, boolean craftable, String materialColor, Supplier<? extends Modifier> trait) {
    return mat(location, fluid, craftable, materialColor, new DataModifierEntry(trait, 1));
  }

  /** Creates a material with a fluid no trait */
  private static IMaterial mat(MaterialId location, Supplier<? extends Fluid> fluid, boolean craftable, String materialColor) {
    return mat(location, fluid, craftable, materialColor, (DataModifierEntry)null);
  }

  /** Creates a material with no fluid */
  private static IMaterial mat(MaterialId location, boolean craftable, String materialColor, @Nullable DataModifierEntry trait) {
    return mat(location, () -> Fluids.EMPTY, craftable, materialColor, trait);

  }
  private static IMaterial mat(MaterialId location, boolean craftable, String materialColor) {
    return mat(location, () -> Fluids.EMPTY, craftable, materialColor, (DataModifierEntry)null);
  }

  /** Creates a material with no fluid and a single trait */
  private static IMaterial mat(MaterialId location, boolean craftable, String materialColor, Supplier<? extends Modifier> trait) {
